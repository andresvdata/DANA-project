...
After computing the chi square we can reject the null hypothesis as the leve of condicen is 0.05 and conclude the variables are not independent.
Also as the content rating change the type could change.